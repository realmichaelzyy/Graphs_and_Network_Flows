    ...
    for i in range(1,len(Dic_Movie_New[key])):
        ...
        for movie in Dic_Act[actor]:
            ...
            if Edge_Movie.has_key((Dic_Movie_New[key][0],Dic_Movie_New[movie][0])):
                Edge_Movie[(Dic_Movie_New[key][0],Dic_Movie_New[movie][0])]+=1
                Edge_MovieDeno[(Dic_Movie_New[key][0],Dic_Movie_New[movie][0])]=totalAct
            elif Edge_Movie.has_key((Dic_Movie_New[movie][0], Dic_Movie_New[key][0])):
                Edge_Movie[(Dic_Movie_New[movie][0], Dic_Movie_New[key][0])]+=1
                Edge_MovieDeno[(Dic_Movie_New[movie][0], Dic_Movie_New[key][0])]=totalAct
            else:
                Edge_Movie[(Dic_Movie_New[key][0],Dic_Movie_New[movie][0])]=1
                Edge_MovieDeno[(Dic_Movie_New[key][0],Dic_Movie_New[movie][0])]=totalAct
